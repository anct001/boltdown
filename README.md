...
Người dùng cuối: chạy `BoltdownSetup-0.6.0.exe` (xem mục [Đóng gói](#đóng-gói)
...
- `dist/BoltdownSetup-0.6.0.exe` — bản cài đặt Inno Setup, ~50 MB (chỉ dựng khi
...
BoltdownSetup-0.6.0.exe  UnknownError   CN=Boltdown Test Signing (self-signed) (timestamped)
```
...
SHA-256 của `BoltdownSetup-0.6.0.exe`:

```
2c090b6aa9dcdaaa3e7187741c022d02cfd10dbf9034d27b49561403c7c932d9
```
